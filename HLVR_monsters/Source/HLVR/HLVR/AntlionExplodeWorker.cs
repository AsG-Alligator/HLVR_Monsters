...
namespace HLVRMonsters
{
	...
	public class DeathActionWorker_AntlionWorkerExplosion : DeathActionWorker
	{
		...
		{
			GenExplosion.DoExplosion(corpse.Position, corpse.Map, 1.9f, HLVRDefOf.HLVR_WorkerBurst, corpse.InnerPawn, -1, -1f, null, null, null, null, null, 0f, 1, false, null, 0f, 1, 0f, false, null, null);
			corpse.Destroy();
		}
	}
}
