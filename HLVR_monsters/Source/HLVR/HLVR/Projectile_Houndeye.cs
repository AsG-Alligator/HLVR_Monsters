...
namespace HLVRMonsters
{
    public class Projectile_HoundeyeBlast : Bullet
    {
        ...
        {
            GenExplosion.DoExplosion(this.Position, this.Map, 3.3f, HLVRDefOf.HLVR_SonicBlast, this, -1, -1f, null, null, null, null, null, 0f, 1, false, null, 0f, 1, 0f, false, null, null);
            this.Destroy();
        }
